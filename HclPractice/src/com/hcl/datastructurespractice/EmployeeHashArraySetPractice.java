...
public class EmployeeHashArraySetPractice {
	public static void main(String[] args) {
		...
		// array list is good for expandable data structure, it can handle duplicates
		// and is good at getting elements at any index.
		...
		// this will get a unique list of objects. if the object is trying to get added
		// twice then it will not work and just overwrite the value
